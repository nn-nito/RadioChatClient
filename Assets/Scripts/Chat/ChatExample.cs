...
namespace Chat
{
    ...
    {
        public Text timeText, text, userName;
        ...
        public override void CollectViews()
        {
            ...
            messageContentPanelImage.transform.GetComponentAtPath("Header/TimeText", out timeText);
            messageContentPanelImage.transform.GetComponentAtPath("Text", out text);
            messageContentPanelImage.transform.GetComponentAtPath("Header/UserName", out userName);
        ...
        {
            timeText.text = model.TimestampAsDateTime.ToString("M/d H:mm:ss");

            if (text.text != model.Text)
